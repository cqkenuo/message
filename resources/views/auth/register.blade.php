...
<div class="zyl_lofo_main" style="height: 450px">
    ...
    <div class="layui-row layui-col-space15">
        <form class="layui-form zyl_pad_01" action="">
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="text" name="phone" lay-verify="required|pass" autocomplete="off" placeholder="手機號碼"
                           class="layui-input">
                    <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
                </div>
            </div>
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="email" name="email" lay-verify="required" autocomplete="off" placeholder="電子郵件"
                           class="layui-input">
                    <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
                </div>
            </div>
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <button class="layui-btn layui-btn-fluid" lay-submit="" lay-filter="demo1">立即註冊</button>
            </div>
        </form>
    </div>
</div>
